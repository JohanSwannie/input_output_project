...
def move_ball():
    global xSpeed, ySpeed, scoreCnt, strSc, saveScore, newSpeed, player, gameOver
...
keerPlank = canvas.create_rectangle(width//2-50, keerPlank_y, width//2+260, keerPlank_y2, fill='black')
